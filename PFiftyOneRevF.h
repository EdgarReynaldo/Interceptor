...
#ifndef PFiftyOneRevFH
#define PFiftyOneRevFH

///#include "CplxD.h" // Only needed with the Iowa Hills Filter Kit.
...
//---------------------------------------------------------------------------
 ...
 #define P51_MINDEGREE   4         // 2, 3, or 4. This is used to control whether P51 or QuadRoots is used to find the last 3rd and 4th roots. Both work well, but in some extreme cases, using 2 will give more accurate results because P51 can iterate to a more accurate solution than the algebraic code in QuadRoots can compute (but not always).
...
// int FindRoots(int N, double *Coeff, CplxD *Roots);  // Only needed with the Iowa Hills Filter Kit.
